...
var $author$project$Routing$Router$updateHome = F2(
	function (model, homeMsg) {
		var _v0 = A2($author$project$Pages$Home$update, homeMsg, model.homeModel);
...
var $author$project$Routing$Router$updateSettings = F3(
	function (sharedState, model, settingsMsg) {
		var _v0 = A3($author$project$Pages$Settings$update, sharedState, settingsMsg, model.settingsModel);
			...
			case 'Success':
				...
				switch (_v1.$) {
					case 'NotReady':
						...
						var _v2 = $author$project$Routing$Router$init(model.url);
