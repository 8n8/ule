...
var $author$project$Main$NonEmptyCache = F5(
	function (customFoods, bodyWeightRecords, waistSizeRecords, meals, popularFoods) {
		return {bodyWeightRecords: bodyWeightRecords, customFoods: customFoods, meals: meals, popularFoods: popularFoods, waistSizeRecords: waistSizeRecords};
	});
...
var $author$project$Main$initModelHelp = F3(
	function (cache, zone, now) {
		return {
			...
			newFoodEnergyBox: '',
			now: now,
			popularFoods: function () {
				if (cache.$ === 'Empty') {
					return $author$project$Foods$empty;
				} else {
					var popularFoods = cache.a.popularFoods;
					return popularFoods;
				}
			}(),
...
var $author$project$Main$SelectedFoodPosition = function (a) {
	return {$: 'SelectedFoodPosition', a: a};
};
...
var $author$project$Main$encodeCache = function (_v0) {
	var popularFoods = _v0.popularFoods;
	var meals = _v0.meals;
...
var $author$project$FoodMass$fromGramString = function (raw) {
	...
	if (_v0.$ === 'Nothing') {
		...
		var intGrams = _v0.a;
		return (intGrams < 0) ? $elm$core$Result$Err('not a positive number') : ((_Utils_cmp(intGrams, $author$project$FoodMass$maxMass) > 0) ? $elm$core$Result$Err('too high') : ((_Utils_cmp(intGrams, $author$project$FoodMass$minMass) < 0) ? $elm$core$Result$Err('too low') : $elm$core$Result$Ok(
				...
				var pageNumR = $author$project$PageNum$first(
					$author$project$Main$totalPages(
						$elm$core$List$length(
							A3($author$project$Main$foodSearch, model.popularFoods, model.customFoods, query))));
				if (pageNumR.$ === 'Err') {
					var err = pageNumR.a;
					return _Utils_Tuple2(
			...
			case 'MealWeightBox':
				...
				return _Utils_Tuple2(
					$author$project$Main$Ok_(
						_Utils_update(
							model,
							{mealNotification: $author$project$Main$Off, mealWeightBox: contents})),
					$elm$core$Platform$Cmd$none);
			case 'SubmitMeal':
					...
					if (_v6.$ === 'Err') {
						...
						var newModel = _Utils_update(
							model,
							{
								...
								popularFoods: A2($author$project$Foods$insert, selectedFood, model.popularFoods)
							});
						return _Utils_Tuple2(
							$author$project$Main$Ok_(newModel),
							$author$project$Main$dumpCache(newModel));
			...
			case 'NewFoodDescriptionBox':
				...
				return _Utils_Tuple2(
					$author$project$Main$Ok_(
						_Utils_update(
							model,
							{foodNotification: $author$project$Main$Off, newFoodDescriptionBox: box})),
					$elm$core$Platform$Cmd$none);
			case 'NewFoodEnergyBox':
				var box = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Ok_(
						_Utils_update(
							model,
							{foodNotification: $author$project$Main$Off, newFoodEnergyBox: box})),
					$elm$core$Platform$Cmd$none);
			case 'BodyWeightBox':
				var box = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Ok_(
						_Utils_update(
							model,
							{bodyWeightBox: box, bodyWeightNotification: $author$project$Main$Off})),
					$elm$core$Platform$Cmd$none);
			case 'SubmitBodyWeight':
				return A2(
			...
			case 'WaistSizeBox':
				...
				return _Utils_Tuple2(
					$author$project$Main$Ok_(
						_Utils_update(
							model,
							{waistSizeBox: box, waistSizeNotification: $author$project$Main$Off})),
					$elm$core$Platform$Cmd$none);
			case 'SubmitWaistSize':
				...
				if (msg.a.$ === 'Err') {
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							A2($elm$browser$Browser$Dom$setViewport, element.x, element.y)));
				}
			case 'NoOp':
				return _Utils_Tuple2(
					$author$project$Main$Ok_(model),
					$elm$core$Platform$Cmd$none);
			case 'UndoDelete':
				var meals = msg.a.meals;
				var waistSizeRecords = msg.a.waistSizeRecords;
				var bodyWeightRecords = msg.a.bodyWeightRecords;
				var customFoods = msg.a.customFoods;
				var newModel = _Utils_update(
					model,
					{bodyWeightRecords: bodyWeightRecords, customFoods: customFoods, meals: meals, undo: $elm$core$Maybe$Nothing, waistSizeRecords: waistSizeRecords});
				return _Utils_Tuple2(
					$author$project$Main$Ok_(newModel),
					$author$project$Main$dumpCache(newModel));
			default:
				var newModel = _Utils_update(
					model,
					{
						bodyWeightRecords: $author$project$BodyWeightRecords$empty,
						customFoods: $author$project$Foods$empty,
						meals: $author$project$Meals$empty,
						undo: $elm$core$Maybe$Just(
							{bodyWeightRecords: model.bodyWeightRecords, customFoods: model.customFoods, meals: model.meals, popularFoods: model.popularFoods, waistSizeRecords: model.waistSizeRecords}),
						waistSizeRecords: $author$project$WaistSizeRecords$empty
					});
				return _Utils_Tuple2(
					$author$project$Main$Ok_(newModel),
					$author$project$Main$dumpCache(newModel));
...
var $author$project$Main$DeleteData = {$: 'DeleteData'};
var $author$project$Main$DownloadData = {$: 'DownloadData'};
var $author$project$Main$OneLessBodyWeightPage = {$: 'OneLessBodyWeightPage'};
var $author$project$Main$OneLessMealsPage = {$: 'OneLessMealsPage'};
var $author$project$Main$OneLessWaistSizePage = {$: 'OneLessWaistSizePage'};
var $author$project$Main$OneMoreBodyWeightPage = {$: 'OneMoreBodyWeightPage'};
var $author$project$Main$OneMoreMealsPage = {$: 'OneMoreMealsPage'};
var $author$project$Main$OneMoreWaistSizePage = {$: 'OneMoreWaistSizePage'};
var $author$project$Main$UndoDelete = function (a) {
	return {$: 'UndoDelete', a: a};
};
var $author$project$Main$UploadData = {$: 'UploadData'};
...
var $author$project$Timestamp$minusDay = function (_v0) {
	var t = _v0.a;
	return $author$project$Timestamp$Timestamp(t - 24);
};
		...
		while (true) {
			if ($author$project$Timestamp$isToday(t)) {
				...
				var $temp$t = _Utils_update(
					t,
					{
						now: $author$project$Timestamp$minusDay(t.now)
					}),
					$temp$accum = accum + 1;
				t = $temp$t;
				accum = $temp$accum;
...
var $author$project$WaistSizeRecords$waistDailyBin = F4(
	function (zone, now, waist, bins) {
		var size = $author$project$WaistSize$toCm(waist.waistSize);
		var daysOld = $author$project$Timestamp$daysAgo(
			{now: now, t: waist.timestamp, zone: zone});
		var _v0 = A2($elm$core$Dict$get, daysOld, bins);
		if (_v0.$ === 'Nothing') {
			return A3(
				$elm$core$Dict$insert,
...
var $author$project$Meals$mealDailyBin = F4(
	function (zone, now, meal, bins) {
		...
		var daysOld = $author$project$Timestamp$daysAgo(
			{
				now: now,
				t: $author$project$Meal$timestamp(meal),
				zone: zone
			});
		var _v0 = A2($elm$core$Dict$get, daysOld, bins);
		if (_v0.$ === 'Nothing') {
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					...
					{less: less, more: more, pageNum: pageNum})
				])));
};
		...
		return A2(
			...
			A2(
				...
				_Utils_ap(
					...
					$author$project$Main$paginationView(
						{less: $author$project$Main$OneLessFoodSearchPage, more: $author$project$Main$OneMoreFoodSearchPage, pageNum: pageNum}))));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A4($author$project$Main$foodSearchView, model.popularFoods, model.customFoods, model.foodSearchBox, model.foodSearchResultsPage),
				...
				function () {
					var data = A3($author$project$BodyWeightRecords$dailyAverage, model.zone, model.bodyWeightRecords, model.now);
					return {data: data, less: $author$project$Main$OneLessBodyWeightPage, more: $author$project$Main$OneMoreBodyWeightPage, now: model.now, pageNum: model.bodyWeightsPage, toString: $author$project$Main$bodyToString, zone: model.zone};
				}()),
				...
				$author$project$Main$dailyChartView(
				function () {
					var data = A3($author$project$WaistSizeRecords$dailyAverage, model.zone, model.waistSizeRecords, model.now);
					return {data: data, less: $author$project$Main$OneLessWaistSizePage, more: $author$project$Main$OneMoreWaistSizePage, now: model.now, pageNum: model.waistSizesPage, toString: $author$project$Main$bodyToString, zone: model.zone};
				}()),
				...
				$author$project$Main$dailyChartView(
				function () {
					var data = A3($author$project$Meals$dailyCalories, model.zone, model.meals, model.now);
					return {
						data: data,
						less: $author$project$Main$OneLessMealsPage,
						more: $author$project$Main$OneMoreMealsPage,
						now: model.now,
				...
				A2(
					...
					{
						label: $mdgriffith$elm_ui$Element$text('Download data'),
						onPress: $elm$core$Maybe$Just($author$project$Main$DownloadData)
					})),
				...
				A2(
					...
					A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$alignLeft, $author$project$Main$lessMoreStyle),
					{
						label: $mdgriffith$elm_ui$Element$text('Upload data'),
						onPress: $elm$core$Maybe$Just($author$project$Main$UploadData)
					})),
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$text('https://fdc.nal.usda.gov/fdc-datasets/FoodData_Central_survey_food_json_2021-10-28.zip'),
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$text('https://github.com/8n8/dietvis'),
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$text('sandwich icon'),
						...
						{
							label: $mdgriffith$elm_ui$Element$text('Twemoji'),
						...
						{
							label: $mdgriffith$elm_ui$Element$text('CC BY 4.0'),
